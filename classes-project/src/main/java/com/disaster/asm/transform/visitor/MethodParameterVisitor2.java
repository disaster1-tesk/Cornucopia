package com.disaster.asm.transform.visitor;
...
public class MethodParameterVisitor2 extends ClassVisitor {
    ...
    private static class MethodParameterAdapter2 extends MethodVisitor {
        ...
        private void printMessage(String str) {
            ...
            super.visitMethodInsn(INVOKESTATIC, "com/disaster/asm/transform/visitor/ParameterUtils", "printText", "(Ljava/lang/String;)V", false);
        }

        private void printValueOnStack(String descriptor) {
            super.visitMethodInsn(INVOKESTATIC, "com/disaster/asm/transform/visitor/ParameterUtils", "printValueOnStack", descriptor, false);
        }
    }
}
