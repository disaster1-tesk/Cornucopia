...
import com.disaster.asm.classreader.visitor.ClassRemoveFieldVisitor;
...
public class ClassRemoveCore {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        ClassVisitor cv = new ClassRemoveFieldVisitor(api, cw, "name", "Ljava/lang/String;");
